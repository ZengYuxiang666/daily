...
def calculate_derived_indicators(df):
    """
    Calculate derived indicators by dividing specified columns.

    Parameters:
    df (pandas.DataFrame): DataFrame containing the original indicators

    Returns:
    pandas.DataFrame: DataFrame with added derived indicators
    """
